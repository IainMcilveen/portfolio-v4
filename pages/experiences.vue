...
const data: ExperienceData[] = [
  {
    ...
    text: "As a Full Stack Developer I was responsible for working on a variety of a different project and technology stacks. I gained experience working with Typescript, SCSS, Vue 3, Nuxt 3, Cypress, FastAPI, ASP NET core with Blazor and MVC, Telerik UI,  SQL server, MongoDB and Github Actions for automated testing and deployment.",
    img: chartdimg,
